...
var require_umd = __commonJS({
  "../node_modules/.pnpm/vscode-uri@3.0.7/node_modules/vscode-uri/lib/umd/index.js"(exports, module2) {
    !function(t, e) {
...
var CURRENT_EDITOR_SELECTED_CODE_TEMPLATE = "I am currently looking at this selected code from `{filePath}`. ";
var CURRENT_EDITOR_SELECTED_CODE_TEMPLATE_WITH_REPO = "I am currently looking at this selected code from `{filePath}` in the {repoName} repository. ";
...
var SourcegraphGraphQLAPIClient = class {
  ...
  dotcomUrl = "https://sourcegraph.com";
  onConfigurationChange(newConfig) {
    this.config = newConfig;
  }
  isDotCom() {
...
var BotResponseMultiplexer = class _BotResponseMultiplexer {
  ...
  static TOPIC_RE = /<$|<\/?([A-Za-z-]?$|[A-Za-z-]+>?)/m;
...
var Interaction = class {
  constructor(humanMessage, assistantMessage, fullContext, usedContextFiles, timestamp = (/* @__PURE__ */ new Date()).toISOString(), pluginExecutionInfos = []) {
  ...
  setUsedContext(usedContextFiles, pluginExecutionInfos) {
    this.usedContextFiles = usedContextFiles;
    this.pluginExecutionInfos = pluginExecutionInfos;
  }
  /**
...
// ../lib/shared/src/chat/viewHelpers.ts
...
// ../lib/shared/src/chat/recipes/agent-recipes.ts
...
// ../lib/shared/src/sourcegraph-api/completions/nodeClient.ts
...
// ../lib/shared/src/sourcegraph-api/completions/parse.ts
...
`
      ...
      this.workspaceRootUri = import_vscode_uri.URI.parse(client.workspaceRootUri || `file://${client.workspaceRootPath}`);
